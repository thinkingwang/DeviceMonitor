function AddOrUpdate-Reference($scriptsFolderProjectItem, $fileNamePattern, $newFileName) {
    ...
    if ((Select-String $referencesFilePath -pattern $fileNamePattern).Length -eq 0) {
        ...
        # Add the full reference line to the ending of the file
...
$easyuiFileName = Join-Path $packageScriptsFolder "jquery.easyui-*.js" | Get-ChildItem -Exclude "*.min.js","*-vsdoc.js" | Split-Path -Leaf
